  ...
  return (
    <div className="my-4">
      <div className="flex space-x-4">
        <div
          className={`w-1/3 text-center ${step >= 1 ? "text-blue-600" : "text-gray-500"}`}
        >
          <span className="font-bold">Bước 1</span>
          <p>Chọn vé</p>
        </div>
        <div
          className={`w-1/3 text-center ${step >= 2 ? "text-blue-600" : "text-gray-500"}`}
        >
          <span className="font-bold">Bước 2</span>
          <p>Nhập thông tin & Thanh toán</p>
        </div>
        <div
          className={`w-1/3 text-center ${step >= 3 ? "text-blue-600" : "text-gray-500"}`}
        >
