    ...
    const tickets = [
        {
            type: "Deluxe Ticket",
            price: "€6.90",
            cancelPolicy: "Hủy miễn phí trước 20:00 18 tháng 11 để được hoàn tiền đầy đủ",
        },
        {
            type: "VIP Ticket",
            price: "€9.15",
                ...
                <div className="text-sm col-span-8 bg-white rounded-lg mt-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white p-4 rounded shadow">
                            ...
                            <h2 className="text-xl font-semibold mt-10">Đánh giá của khách hàng</h2>
                            <div className="text-lg font-semibold">4.5 - Tuyệt vời (970 đánh giá)</div>
                            <div className="space-y-2 mt-4">
                                {["Đáng giá tiền", "Chất lượng dịch vụ", "Tiện nghi", "Dễ tiếp cận"].map((item, index) => (
                                    <div key={index} className="flex items-center">
                                        ...
                                        <div className="w-2/3 bg-gray-200 rounded-full h-2.5 relative">
                                            <div
                                                ...
                                                style={{ width: `${[4.6, 4.5, 4.5, 4.7][index] * 20}%` }}
                                            ></div>
                                        </div>
                            ...
                            <h2 className="text-xl font-semibold mt-10">Điều khách yêu thích nhất</h2>
                            <div className="space-y-4">
                                {[
                                    {
                                        user: "Hong - Việt Nam",
                                        comment: "Độc đáo, thú vị, là nơi có thể đưa bạn bè người thân giải trí cuối tuần",
                                        date: "06 tháng 3, 2024",
                                    },
                                    {
                                        user: "Ny - Việt Nam",
                                        comment: "Mình đến muộn vì tắc đường nhưng vẫn được các bạn hỗ trợ nhiệt tình...",
                            ...
                            <ul className="list-disc pl-6 text-gray-700">
                                <li>Vui lòng có mặt ít nhất 15 phút trước khi hoạt động bắt đầu.</li>
                            </ul>
                            ...
                            <ul className="list-disc pl-6 text-gray-700 space-y-2">
                                ...
                                <li>Lưu ý rằng nhà cung cấp có thể hủy vì những lý do không biết trước.</li>
                        ...
                        <div className="bg-white p-4 rounded shadow">
                            <div className="">
                                ...
                                {tickets.map((ticket, index) => (
                                    <div key={index} className="border p-4 rounded-lg shadow mt-10">
                                        <h3 className="text-lg font-bold">{ticket.type}</h3>
                                        <p className="text-green-600 font-semibold">{ticket.cancelPolicy}</p>
                                        <p className="text-gray-700 mt-2">Từ <span className="font-bold">{ticket.price}</span></p>
                                        <button className="mt-4 py-2 px-4 bg-blue-500 text-white rounded">Chọn</button>
                                    </div>
                                ))}
                            </div>
                        </div>
