...
const RentalDetailPage = () => {
  ...
  const getMotorImageUrl = (model: string, token: string) => {
      ...
      <section className='p-6 !pt-2 mx-auto max-w-6xl grid grid-cols-4 gap-4'>
        <div className='col-span-3 p-4 bg-white border rounded-lg hover:shadow-lg transition-shadow duration-200'>
          <div className='grid grid-cols-2 gap-4 my-4 pb-4'>
            <div className='h-auto'>
              <img
                src={getMotorImageUrl(rentalItem.model, rentalItem.token)}
                alt={`Motor ${rentalItem.id}`}
        ...
        <div className='col-span-1 p-4 bg-white border rounded-lg hover:shadow-lg transition-shadow duration-200'>
          ...
          <div className='space-y-2 mt-4 text-sm leading-loose'>
            ...
            <button className='bg-[#018DF3] text-white py-2 rounded mt-4 w-full'>Tiếp tục</button>
          </div>
        </div>
        ...
        <div className='col-span-3 p-4 bg-white border rounded-lg hover:shadow-lg transition-shadow duration-200'>
          ...
          <div className='space-y-4 p-4'>
            <div>
              ...
              <input type="text" className='border rounded p-1 w-full' placeholder='Noi Bai International Airport (HAN)' />
            </div>
          </div>
          <div className='space-y-4 p-4'>
            <div>
