...
const HotelDetailPage = () => {
  ...
  const hotelItem = listings.content.listHotels.find(item => item.id.toString() === id);
      ...
      <section className="px-6 py-2 mx-auto max-w-7xl grid grid-cols-4 gap-4">
        <div className="col-span-4 p-4 bg-white border rounded-lg hover:shadow-lg transition-shadow duration-200">
          <div className='grid grid-cols-8 gap-2'>
            ...
            <div className="col-span-8 bg-white rounded-lg mt-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="border p-4 rounded-lg">
                  <div className="flex items-center mb-4">
                    <span className="bg-blue-500 text-white rounded-lg px-3 py-1 text-xl font-bold">
                      {hotelItem.rating.toFixed(1)}
                    </span>
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold">Ấn tượng</h3>
                      <p className="text-gray-600">Từ {hotelItem.reviewCount} đánh giá của khách đã ở</p>
                    </div>
                  </div>
                  <h4 className="font-semibold mb-2">Khách nói gì về kỳ nghỉ của họ</h4>
                </div>

                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Trong khu vực</h4>
                ...
                <div className="border p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Tiện ích chính</h4>
